...
const setEquipmentsEvents = (equipments) => {
        equipments.forEach(equipment => 
        {
            onUpdateField(`${equipment.id}-${equipment.name}`, (event) => {
                ...
                console.log(propertyAdd.equipments);
            });
        });
    };
...
onUpdateField('squareMeter', (event) => {
        propertyAdd = {...propertyAdd, squareMeter: event.target.value};
});

onUpdateField('rooms', (event) => {
        propertyAdd = {...propertyAdd, rooms: event.target.value};
});

onUpdateField('bathrooms', (event) => {
        propertyAdd = {...propertyAdd, bathrooms: event.target.value};
});
