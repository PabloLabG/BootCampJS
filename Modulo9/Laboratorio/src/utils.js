...
const addCharacterQuotes = (quotes) => {
  console.log("quotes", quotes);
  const characterDetail = document.getElementById("character-detail");

  for (const quote of quotes) {
    characterDetail.appendChild(createParagraph("Quote: " + quote.quote));
  }
};
...
export { createCharacterRow, showCharacter, addCharacterQuotes };
